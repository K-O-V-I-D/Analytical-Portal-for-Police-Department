...
let cityArr = ['Indore', 'Amreli', 'Guna', 'Bhopal', 'Gwalior', 'Bharuch', 'Bhind', 'Botad', 'Morena', 'Dahod', 'Pipariya', 'Ujjan', 'Sehore', 'Kothri', 'Gadarwada', 'Dhana', 'Khandwa', 'Kariraat', 'Mahisagar', 'Mehsana', 'Morbi', 'Narmada (Rajpipla)', 'Navsari', 'Panchmari', 'Jabalpur', 'Narshingpur', 'Chhindwara', 'Sabarkantha (Himmatnagar)', 'Ratlam', 'Surendranagar', 'Tapi (Vyara)', 'Satna', 'Valsad']
